   ...
   return (
    <main className="min-h-screen bg-[#F5F7FB] flex flex-col items-center justify-center p-6 relative overflow-hidden">
      ...
      <div className="absolute top-0 left-1/2 -translate-x-1/2 w-full max-w-[1000px] h-full pointer-events-none opacity-40">
        <div className="absolute top-[-10%] left-[-10%] w-[50%] h-[50%] rounded-full bg-[#6B7A90]/5 blur-[120px]" />
        <div className="absolute bottom-[-10%] right-[-10%] w-[40%] h-[40%] rounded-full bg-[#6B7A90]/5 blur-[100px]" />
      </div>
       ...
       <div className="w-full max-w-[460px] relative z-10">
         ...
         <div className="flex items-center justify-between mb-10 pb-6 border-b border-[#1a1a1c]/5">
           ...
           <div className="mb-8 text-center">
             <h2 className="text-2xl font-bold text-[#1a1a1c] tracking-tight mb-1">Welcome back</h2>
             <p className="text-sm text-[#1a1a1c]/40 font-medium">Please enter your account details</p>
           </div>
           ...
           <form onSubmit={handleSignIn} className="space-y-5">
             ...
             <div className="space-y-2">
               ...
               <div className="flex justify-end px-1">
                 <Link href="#" className="text-[10px] font-bold text-[#6B7A90] hover:underline underline-offset-4 tracking-tight">
                   Forgot password?
                 </Link>
               </div>
             </div>
           ...
           <div className="mt-8 pt-8 border-t border-[#1a1a1c]/5 text-center">
             <p className="text-[#1a1a1c]/40 font-bold text-xs">
               ...
               <Link href="/sign-up" className="text-[#6B7A90] hover:underline ml-1">Create one</Link>
             </p>
           </div>
         </motion.div>
       </div>
