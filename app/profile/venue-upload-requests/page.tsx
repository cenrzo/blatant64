  ...
  return (
    <main className="min-h-screen bg-[#f7f6fd] relative font-sans">
      ...
      <div className="pt-[104px] px-6 md:px-12 max-w-[1400px] mx-auto pb-20 relative z-10">
        ...
        {venues.length === 0 ? (
          <div className="p-12 rounded-[14px] bg-white/60 dark:bg-slate-900/60 backdrop-blur-xl border border-border/50 flex flex-col items-center justify-center text-center shadow-lg">
            ...
            <AnimatePresence mode="popLayout">
              {venues.map((venue) => (
                <motion.div
                  ...
                  className="p-6 sm:p-8 rounded-[14px] bg-white/80 dark:bg-slate-900/80 backdrop-blur-xl border border-border/50 shadow-sm transition-all duration-300 hover:shadow-xl hover:border-accent/30"
                >
