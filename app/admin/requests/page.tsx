    ...
    <main className="min-h-screen bg-[#F5F7FB] font-sans">
      <div className="max-w-6xl mx-auto px-6 lg:px-8 py-12 relative z-10 pt-24 sm:pt-32">
        <div className="flex items-center justify-between mb-8">
          <div>
            <h1 className="text-4xl md:text-5xl font-bold text-[#111111] mb-2">Venue Requests</h1>
            <p className="text-[#6B7A90]">Review and approve pending venue submissions</p>
          </div>
          <Link
            href="/admin"
            className="inline-flex items-center gap-2 px-5 py-2.5 rounded-[12px] bg-white hover:bg-[#F5F7FB] text-[#111111] border border-[#E7ECF3] transition-all duration-300 font-semibold"
          >
        ...
        {loading ? (
          ...
          <div className="p-12 rounded-[14px] border-2 border-dashed border-[#E7ECF3] text-center bg-white">
            <p className="text-[#6B7A90] text-lg">No pending requests to review</p>
          </div>
        ) : (
          <div className="space-y-4">
            <div className="text-sm font-semibold text-[#6B7A90] mb-4">
            ...
            {venues.map((venue) => (
              <div
                key={venue.id}
                className="p-6 rounded-[14px] bg-white border border-[#E7ECF3] shadow-[0_4px_24px_rgba(107,122,144,0.04)] hover:shadow-md transition-all duration-300"
              >
                <div className="flex gap-6">
                  {venue.images.length > 0 && (
                    <div className="hidden sm:block w-24 h-24 rounded-lg overflow-hidden bg-[#F5F7FB] flex-shrink-0">
                      <img
                        src={venue.images[0]}
                        alt={venue.spaceName}
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex items-start justify-between gap-4 mb-3">
                      <div>
                        <h3 className="text-xl font-bold text-[#111111] mb-1">{venue.spaceName}</h3>
                      ...
                      <button
                        ...
                        className="text-[#111111] hover:text-[#6B7A90] transition-colors font-bold text-sm"
                      >
                    ...
                    {expandedVenueId === venue.id && (
                      <div className="space-y-4 mb-6 p-4 rounded-[12px] bg-[#F5F7FB] border border-[#E7ECF3]">
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                          <div>
                            <p className="text-xs font-semibold text-[#6B7A90] uppercase tracking-wider mb-1">
                              Location
                            </p>
                            <p className="text-[#111111]">{venue.location}</p>
                          </div>
                          <div>
                            <p className="text-xs font-semibold text-[#6B7A90] uppercase tracking-wider mb-1">
                              Price & Capacity
                        ...
                        <div>
                          <p className="text-xs font-semibold text-[#6B7A90] uppercase tracking-wider mb-2">
                            Description
                          </p>
                          <p className="text-[#111111] text-sm leading-relaxed">{venue.description}</p>
                        </div>
                        ...
                        <button
                          ...
                          className="w-full mt-4 flex items-center justify-center gap-2 py-2.5 rounded-[12px] bg-white border border-[#E7ECF3] text-[#111111] font-bold transition-all hover:bg-[#F5F7FB]"
                        >
                          Edit Details
                        </button>
                      </div>
                    ...
                    <div className="space-y-3">
                      <div className="flex gap-3">
                        <button
                          ...
                          className="flex-1 flex items-center justify-center gap-2 py-3 px-4 rounded-[12px] bg-[#111111] hover:bg-black text-white font-bold transition-all duration-300 disabled:opacity-50 disabled:cursor-not-allowed"
                        >
                          {processing === venue.id ? (
                        ...
                        <button
                          ...
                          className="flex-1 flex items-center justify-center gap-2 py-3 px-4 rounded-[12px] bg-white border border-[#E7ECF3] hover:bg-[#F5F7FB] text-[#111111] font-bold transition-all duration-300"
                        >
                          <X className="w-4 h-4" />
                          Deny
                        </button>
                      ...
                      {expandedVenueId === `${venue.id}-reject` && (
                        <div className="space-y-2">
                          <textarea
                            ...
                            className="w-full p-3 rounded-[12px] border border-[#E7ECF3] bg-white text-[#111111] placeholder-[#6B7A90] focus:outline-none focus:ring-1 focus:ring-[#111111] resize-none"
                            rows={3}
                          />
                          <button
