...
export function HeroSection() {
  ...
  return (
    <section className="relative w-full h-[580px] md:h-[640px] lg:h-[700px] min-[1440px]:h-[780px] min-[1700px]:h-[900px] max-h-[713px]:h-[560px] overflow-visible bg-transparent z-[20]">
      <div
        className="absolute inset-0 z-1 bg-no-repeat bg-cover w-full h-full pointer-events-none"
        style={{
      ...
      <div className="absolute inset-0 z-[2] pointer-events-none" style={{ background: "linear-gradient(to bottom, rgba(0,0,0,0.25) 0%, transparent 40%, transparent 100%)" }} />
