  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 flex flex-col items-start">
        <h3 className={`text-white font-bold ${variant === "compact" ? "text-[20px] md:text-[22px] mb-0.5 truncate w-full" : "text-[26px] md:text-[30px] mb-1"} leading-tight tracking-tight drop-shadow-[0_2px_8px_rgba(0,0,0,0.3)] ${isGeorgian ? "font-georgian" : ""}`}>
          {isGeorgian && titleKa ? titleKa : title}
        </h3>

        <div className={`flex items-center ${variant === "compact" ? "gap-1 mb-1.5 text-[12px]" : "gap-1.5 mb-3 text-[13px]"} text-white/80 w-full`}>
        ...
        <div className="flex items-baseline gap-1">
          <span className={`text-white font-bold ${variant === "compact" ? "text-lg md:text-xl" : "text-xl md:text-2xl"}`}>
            ${price}
          </span>
