          ...
          <div className="w-full pointer-events-auto" style={bgStyle}>
            ...
            >
              <Link
                ...
                style={{ color: textColor || "#3b568c", transition: "color 0.4s ease" }}
              >
      ...
      >
        <div className="w-full max-w-[1600px] min-[1700px]:max-w-[1800px] mx-auto px-6 md:px-12 grid grid-cols-3 items-center">
          ...
          <div className="flex items-center justify-start">
            {!isMobile && (
              <nav className="hidden md:flex items-center gap-1 min-[1440px]:gap-1.5 bg-[#f4f5f7] rounded-[14px] px-1.5 py-1">
                {[
                  { href: "/", label: "Home" },
                  { href: "/houses", label: "Venues" },
                  ...
                  return (
                    <Link
                      ...
                      className={`relative px-4 py-2 rounded-[10px] text-[12.5px] font-semibold transition-all duration-300 ${isActive
                        ? "bg-[#556457] text-[rgba(255,255,255,0.95)] shadow-[0_2px_8px_rgba(0,0,0,0.12)]"
                        : "text-[#666] hover:text-[#111] hover:bg-[#6B7D6D]/10"
                        }`}
                    >
                      {link.label}
                    </Link>
          ...
          <div className="flex items-center justify-center">
            <Link href="/" className="text-[#1a1a1c] flex-shrink-0 flex items-center transition-transform duration-250" style={{ transform: scrollDir === "down" && scrolled ? "scale(0.92)" : "scale(1)" }}>
          ...
          {/* Right: Actions */}
          <div className="flex items-center justify-end gap-2 md:gap-3 min-w-[150px]">
            ...
            {!loading ? (
              user ? (
                ...
                <div className="flex items-center">
                  <button
                    onClick={() => setAuthModalOpen(true)}
                    className="flex items-center justify-center font-bold bg-[#1a1a1c] text-white rounded-md px-5 py-2 text-[12.5px] shadow-[0_2px_8px_rgba(0,0,0,0.12)] hover:bg-black hover:shadow-[0_4px_14px_rgba(0,0,0,0.18)] hover:scale-[1.02] transition-all duration-300 cursor-pointer"
                  >
                    Log In / Sign Up
                  </button>
                </div>
